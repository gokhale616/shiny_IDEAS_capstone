...
Saiga, a species previously decimated by poaching, are endangered like many other wild animals today. Host animals are more likely to be negatively impacted by parasitism if they are already facing other stressors such as poaching and habitat loss. Since the the number of endangered and threatened animals is on the rise, understanding patterns of parasitism is important for identifying conservation strategies for imperiled host animals.

This dashboard is a resource for scientists and non-scientists alike to visualize patterns of parasitic disease in threatened host mammals. We focus on carnivore and ungulate host mammals because these two taxonomic orders include all major groups of domesticated livestock (dogs, cats, goats, sheep, cattle, and pigs), showing the dangers of cross-species transmission that pets and livestock pose to closely related wild species. Parasites include arthropods, bacteria, helminths, insecta, viruses, fungi, and protozoans.</font>
...
<font size="4"> Placeholder text..................................... </font> 
